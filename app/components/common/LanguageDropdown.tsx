...
export default function LanguageDropdown() {
  ...
  return (
    <div className="inline-block">
      ...
      >
        <option value="en" className="bg-slate-900 text-slate-100">{texts.englishOption}</option>
        <option value="es" className="bg-slate-900 text-slate-100">{texts.spanishOption}</option>
        <option value="ko" className="bg-slate-900 text-slate-100">{texts.koreanOption}</option>
      </select>
    </div>
  );
}
