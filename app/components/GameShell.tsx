...
export default function GameShell({ title, description, children, scoreboard }: GameShellProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Game Header */}
        <div className="mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-purple-600 mb-3">{title}</h1>
