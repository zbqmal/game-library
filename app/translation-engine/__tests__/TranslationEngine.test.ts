  ...
  describe("getTranslations", () => {
    ...
    it("should have all required translation keys for all languages", () => {
      const requiredKeys = [
        ...
        "onlineStopGameError",
        "onlineGameStoppedByHost",
        "onlineStopGameConfirm",
        "onlineTitleReconnecting",
        "onlineDescReconnecting",
        "onlineTitleLanding",
        "onlineDescLanding",
        "onlineTitleInProgress",
        "onlineDescInProgress",
        "onlineTitleLobby",
        "onlineDescLobby",
        "onlineTitleLoading",
        "onlineDescLoading",
        "onlineBackToTreasureHunt",
        "onlineUsernameLabel",
        "onlineUsernamePlaceholder",
        "onlineNumberOfPlayersLabel",
        "onlineMaxPlayersInfo",
        "onlinePlayerCountNote",
        "onlineCreateRoomTitle",
        "onlineCreatingLabel",
        "onlineCreateRoomButton",
        "onlineJoinRoomTitle",
        "onlineRoomCodePlaceholder",
        "onlineJoiningLabel",
        "onlineJoinRoomButton",
        "onlineQuickTipsTitle",
        "onlineQuickTip1",
        "onlineQuickTip2",
        "onlineQuickTip3",
        "onlineRoomCodeLabel",
        "onlineCopiedLabel",
        "onlineCopyCodeButton",
        "onlineLinkCopiedLabel",
        "onlineShareLinkButton",
        "onlinePlayersHeading",
        "onlinePlayerLabel",
        "onlineTurnIndicator",
        "onlineDisconnectedLabel",
        "onlineYouLabel",
        "onlineBackInLobby",
        "onlineCanBeChanged",
        "onlineSetAtCreation",
        ...
        "onlineClickTileHint",
        "onlineChooseTile",
        "onlineWaitingForPlayer",
        "onlineProgressLabel",
        "onlineStopGameButton",
        "onlineStopGameWarning",
        "onlineLeavingWarning",
        "onlineStartingLabel",
        "onlineBackToLobbyButton",
        "onlineReturningLabel",
        "onlineWaitingForHostLabel",
        "onlineOnlyHostCanReturn",
        "onlineWaitingForAtLeastTwoPlayers",
        "onlineLeaveRoomButton",
        "onlineWaitingForHostToStart",
        "onlineLoadingLabel",
        "onlineReconnectingLabel",
        "onlineStoppingLabel",
        "onlineShareTitle",
        "onlineShareText",
      ];
